...
activityRouter.get("/:pit_id/detail", withRole("Viewer", ActivityController.pit_idDetail))
...
activityRouter.post("/votes/places", withRole("Owner", VoteController.postInit))
activityRouter.post("/votes/events", withRole("Owner", VoteController.postInit))
