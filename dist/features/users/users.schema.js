...
exports.GoogleAuthSchema = exports.IdTokenSchema = exports.ProfileNullableSchema = exports.ProfileFileSchema = exports.UsersFullSchema = exports.UserSchema = void 0;
...
exports.UsersFullSchema = zod_1.default.object({
    ...
    profile_picture_path: zod_1.default.string()
});
