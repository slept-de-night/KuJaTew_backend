...
export declare const UsersService: {
    ...
    get_user_details_byemail(email: string): Promise<(Omit<z.infer<typeof UsersFullSchema>, "profile_picture_path"> & {
        "profile_picture_link": string;
    }) | null>;
    gen_name(name: string): Promise<string>;
    get_invited(user_id: string): Promise<z.infer<typeof InvitedSchema>>;
};
export declare function downloadToProfileFile(rawUrl: string): Promise<ProfileFile>;
